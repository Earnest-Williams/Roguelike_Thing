...
export function colorForType(type) {
  ...
  if (t === DAMAGE_TYPE.SLASH) return "#ffffff";
  if (t === DAMAGE_TYPE.PIERCE) return "#9dd6ff";
  if (t === DAMAGE_TYPE.BLUNT) return "#d2c59c";
  ...
  if (t === DAMAGE_TYPE.RADIANT) return "#ffe680";
  if (t === DAMAGE_TYPE.NECROTIC) return "#8050a0";
  return "#ffffff";
}
...
export function dominantAffinity(actor) {
  ...
  if (!affinityMap) return DEFAULT_MARTIAL_DAMAGE_TYPE;
