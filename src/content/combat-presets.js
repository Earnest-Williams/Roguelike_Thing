...
export function summarizeSampleGear(sample) {
  if (!sample) return { id: "", resists: {}, affinities: {}, power: 0, brandCount: 0 };
  let resists = {};
  let affinities = {};
  let power = 0;
  let brandCount = 0;
...
export const SAMPLE_GEAR_SUMMARIES = Object.freeze(
  SAMPLE_GEARSETS.map((sample) => summarizeSampleGear(sample)),
);
