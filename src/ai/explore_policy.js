...
/** @typedef {Record<string, boolean>} GateState */
/** @typedef {Record<string, number>} WeightTable */
/** @typedef {Record<string, number>} ThresholdTable */
/** @typedef {Record<string, string>} FormulaTable */

/**
 * @typedef {Object} PathCostWeights
 * @property {number} base
 * @property {number} lighting
 * @property {number} threat
 * @property {number} lava
 * @property {number} revisit
 * @property {number} loot
 * @property {number} unexplored
 */

/**
 * @typedef {Object} ExplorePolicyDefinition
 * @property {string} id
 * @property {string} label
 * @property {string} [description]
 * @property {GateState} [switches]
 * @property {ThresholdTable} [thresholds]
 * @property {WeightTable} [weights]
 * @property {GateState} [gates]
 * @property {FormulaTable} [formulas]
 * @property {Partial<PathCostWeights>} [pathCost]
 * @property {Record<string, unknown>} [metadata]
 */

/**
 * @typedef {ExplorePolicyDefinition & {
 *   switches: GateState;
...
/** @typedef {Record<string, ExplorePolicyDefinition>} ExplorePolicyCatalog */
...
/**
 * @param {ExplorePolicyDefinition} def
 * @returns {ExplorePolicy}
 */
export function normalizePolicy(def) {
  const base = def || /** @type {ExplorePolicyDefinition} */ ({});
  return /** @type {ExplorePolicy} */ ({
    ...base,
...
/**
 * @param {ExplorePolicyDefinition} base
 * @param {Partial<ExplorePolicyDefinition>} [overrides]
 * @returns {ExplorePolicy}
 */
...
/**
 * @param {ExplorePolicyDefinition} json
 * @returns {ExplorePolicy}
 */
...
export const POLICY_PRESETS = /** @type {ExplorePolicyCatalog} */ (
  Object.freeze({
    cartographer: {
      id: "cartographer",
      label: "Cartographer",
