...
import { getLightFalloffSettings, resetLightFalloffSettings, setLightFalloffSettings, subscribeLightFalloffSettings, } from "../world/light_settings.js";
/**
 * @param {number} value
 */
...
export function mountLightSettingsPanel(options = {}) {
    const root = options.panel instanceof HTMLElement
        ? options.panel
    ...
    const inputs = {
        deadZoneTiles: /** @type {HTMLInputElement | null} */ (root.querySelector('[data-setting="deadZoneTiles"]')),
        smoothstepRangeMultiplier: /** @type {HTMLInputElement | null} */ (root.querySelector('[data-setting="smoothstepRangeMultiplier"]')),
        falloffPower: /** @type {HTMLInputElement | null} */ (root.querySelector('[data-setting="falloffPower"]')),
    };
    ...
    const editableNodes = Array.from(root.querySelectorAll("[data-editable='true']")).filter((el) => el instanceof HTMLInputElement || el instanceof HTMLButtonElement);
    const stateMessage = /** @type {HTMLElement | null} */ (root.querySelector("[data-state-message]"));
