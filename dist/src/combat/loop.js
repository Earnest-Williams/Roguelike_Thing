// src/combat/loop.js
// @ts-nocheck
import { applyOneStatusAttempt, hasStatus, rebuildDerived, removeStatusById, tickStatusesAtTurnStart, } from "./status.js";
...
export function runTurn(actor, actionPlanner) {
    ...
    if (isPromiseLike(plannerResult)) {
        if (typeof console !== "undefined" && console.warn) {
            console.warn("runTurn received an async planner; prefer runTurnAsync to await the result.");
        }
