...
export class Fixture extends Furniture {
    constructor({ id = null, kind = FurnitureKind.GENERIC, name = "Fixture", orientation = FurnitureOrientation.FLOOR, material = null, tags = [], metadata = {}, footprint = null, } = {}) {
...
export class Table extends Fixture {
    constructor({ id = null, name = "Table", material = "wood", tags = [], metadata = {}, footprint = { width: 2, depth: 1 }, shape = "rectangular", seating = 2, } = {}) {
...
export class Chair extends Fixture {
    constructor({ id = null, name = "Chair", material = "wood", tags = [], metadata = {}, footprint = { width: 1, depth: 1 }, hasBack = true, } = {}) {
        const baseMetadata = metadata && typeof metadata === "object" ? { ...metadata } : {};
        const mergedMetadata = {
            ...baseMetadata,
            seatingCapacity: 1,
...
export class StorageChest extends Fixture {
    constructor({ id = null, name = "Chest", material = "wood", tags = [], metadata = {}, footprint = { width: 2, depth: 1 }, capacity = 12, } = {}) {
        const baseMetadata = metadata && typeof metadata === "object" ? { ...metadata } : {};
        const mergedMetadata = {
            ...baseMetadata,
            capacity,
...
export class Lamp extends Fixture {
    constructor({ id = null, name = "Lamp", material = "bronze", tags = [], metadata = {}, footprint = { width: 1, depth: 1 }, lightRadius = 4, fuelType = "oil", } = {}) {
        const baseMetadata = metadata && typeof metadata === "object" ? { ...metadata } : {};
        const mergedMetadata = {
            ...baseMetadata,
            lightRadius,
        ...
        const declaredLight = baseMetadata.light && typeof baseMetadata.light === "object"
            ? baseMetadata.light
            : null;
        const radiusCandidate = declaredLight?.radius ?? baseMetadata.lightRadius ?? lightRadius;
        const radius = Number.isFinite(radiusCandidate) ? Number(radiusCandidate) : 0;
        if (radius > 0) {
            const color = typeof declaredLight?.color === "string"
                ? declaredLight.color
                : typeof baseMetadata.lightColor === "string"
                    ? baseMetadata.lightColor
                    : "#ffe9a6";
            const intensityCandidate = declaredLight?.intensity ?? baseMetadata.lightIntensity;
...
export class Rug extends Fixture {
    constructor({ id = null, name = "Rug", material = "cloth", tags = [], metadata = {}, footprint = { width: 3, depth: 2 }, pattern = "geometric", } = {}) {
        const baseMetadata = metadata && typeof metadata === "object" ? { ...metadata } : {};
        const mergedMetadata = {
            ...baseMetadata,
            pattern,
