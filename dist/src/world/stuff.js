...
export class Stuff {
     ...
     */
    constructor({ id, name, category = "generic", tags = [], density = null, hardness = null, description = "", }) {
...
export const STUFF = Object.freeze({
    WOOD: StuffCatalog.register(new Stuff({
        id: "wood",
        name: "Wood",
        category: "organic",
    ...
    STONE: StuffCatalog.register(new Stuff({
        id: "stone",
        name: "Stone",
        category: "mineral",
        tags: ["durable"],
    ...
    IRON: StuffCatalog.register(new Stuff({
        id: "iron",
        name: "Iron",
        category: "metal",
    ...
    STEEL: StuffCatalog.register(new Stuff({
        id: "steel",
        name: "Steel",
        category: "metal",
    ...
    BRONZE: StuffCatalog.register(new Stuff({
        id: "bronze",
        name: "Bronze",
        category: "metal",
        tags: ["forgeable"],
    ...
    DARKWOOD: StuffCatalog.register(new Stuff({
        id: "darkwood",
        name: "Darkwood",
        category: "organic",
    ...
    MARBLE: StuffCatalog.register(new Stuff({
        id: "marble",
        name: "Marble",
        category: "stone",
    ...
    CLOTH: StuffCatalog.register(new Stuff({
        id: "cloth",
        name: "Cloth",
        category: "textile",
        tags: ["soft", "weavable"],
    ...
    GLASS: StuffCatalog.register(new Stuff({
        id: "glass",
        name: "Glass",
        category: "mineral",
    ...
    OBSIDIAN: StuffCatalog.register(new Stuff({
        id: "obsidian",
        name: "Obsidian",
        category: "stone",
        tags: ["sharp", "ritual"],
