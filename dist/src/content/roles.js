...
function validatePolarity(scope, payload) {
    ...
    if (payload.grant)
        validateNumberMap(`${scope}.grant`, payload.grant);
    if (payload.onHitBias)
        validateNumberMap(`${scope}.onHitBias`, payload.onHitBias);
    if (payload.defenseBias)
        validateNumberMap(`${scope}.defenseBias`, payload.defenseBias);
}
